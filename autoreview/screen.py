...
def _build_intervention_keywords(intervention_str):
    ...
    expansions = {
        ...
        "ace inhibitor": ["ace inhibitor", "enalapril", "ramipril", "lisinopril",
                          "perindopril", "captopril", "sacubitril", "entresto"],
        "arb": ["arb", "losartan", "valsartan", "candesartan", "irbesartan",
                 "telmisartan", "olmesartan", "sacubitril", "entresto"],
        "arni": ["arni", "sacubitril", "entresto", "valsartan"],
        "beta blocker": ["beta blocker", "metoprolol", "bisoprolol", "carvedilol",
                         "atenolol", "nebivolol"],
        "anticoagulant": ["anticoagulant", "warfarin", "apixaban", "rivaroxaban",
                          "dabigatran", "edoxaban"],
        "mineralocorticoid": ["mineralocorticoid", "mra", "spironolactone",
                               "eplerenone", "finerenone"],
        "antiplatelet": ["antiplatelet", "ticagrelor", "prasugrel", "clopidogrel",
                          "aspirin", "p2y12"],
        "pcsk9": ["pcsk9", "evolocumab", "alirocumab", "inclisiran"],
        "glp-1": ["glp-1", "glp1", "semaglutide", "liraglutide", "dulaglutide",
